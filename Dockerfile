...
RUN apt-get update -y && apt-get install python-software-properties software-properties-common -y \
    ...
    && php7.0-cli php7.0-gd php7.0-dev php7.0-json \
    && php7.0-mysql php7.0-xml php7.0-xmlrpc php7.0-imap \
    && php7.0-mbstring php7.0-zip wget php-redis -y \
